//! Per-image detection and crop export workflow.
...
use crate::{
    ...
    args::DetectArgs,
    gpu,
    input::{self, resolve_override_output_path},
    output_path::{self, build_crop_output_path, normalized_output_extension, save_processed_crop},
    types::{DetectionRecord, ImageDetections, ProgressCounters},
};
#[cfg(test)]
